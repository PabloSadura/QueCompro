 ...
 export default function geminiPrompt(shoppingResults, userQuery) {
  ...
  const prompt = `
            ...
            Tu único objetivo es realizar un **análisis técnico profundo y objetivo** de los resultados de Google Shopping para seleccionar y justificar las **3 mejores opciones de compra**. Finalmente, debes elegir **uno de esos 3 productos** como la **opción de compra definitiva**, justificando esta decisión en la superioridad técnica.
            ...
            **Resultados de Google Shopping (Fuente de Datos Primaria):**
            ...
            4.  **Selección de las 3 Opciones Finales:** Elige exactamente 3 productos que ofrezcan el **mejor balance** entre potencia/funcionalidad técnica y la validación positiva de los usuarios.
            5.  **Decisión de Compra (EL PASO CLAVE):** Basado puramente en tu análisis técnico, **selecciona cuál de los 3 productos comprarías personalmente**. Esta es la base de la "recomendacion_final".
            6.  **Descarte Explícito:** Ignora completamente información no técnica como el precio, el nombre del vendedor, los costos de envío y la disponibilidad o enlaces.
            ...
            **Devuelve EXCLUSIVAMENTE un único objeto JSON válido**, sin ningún texto introductorio, explicativo, o de cierre.
            ...
            2.  **Reglas de Estructura:**
                * "productos_analisis" debe contener **exactamente 3 objetos**.
